...
public class SoftKeyboard extends InputMethodService
    ...
    Context context;
    private static final int REQ_CODE_SPEECH_INPUT = 1020;
    Activity activity;
    ...
    private void askSpeechInput() {
        ...
        try {
            ...
            Toast.makeText(activity, "failde", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void commitTyped1(InputConnection inputConnection) {
        inputConnection.commitText("hello...", mComposing.length());
        mComposing.setLength(0);
        updateCandidates();
    ...
    public void onKey(int primaryCode, int[] keyCodes) {
        ...
        if (isWordSeparator(primaryCode)) {
            ...
            return;
        }else if (primaryCode == LatinKeyboardView.VOICE_TYPE) {
            commitTyped1(getCurrentInputConnection());
